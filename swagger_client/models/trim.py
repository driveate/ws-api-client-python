...
class Trim(object):
    ...
    def slug(self):
        ...
        Combines trim and body name. Format: __*`trim+body`*__ if both values provided, otherwise non-empty of them. (e.g. `2.0+GG2W`)  # noqa: E501
    ...
    def name(self):
        ...
        Format: __*`trim (body)`*__ if both values provided, otherwise non-empty of them. (e.g. `2.0 (GG2W)`)  # noqa: E501
