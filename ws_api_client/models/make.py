...
class Make(object):
    ...
    def __init__(self, slug=None, name=None, name_en=None):  # noqa: E501
        """Make - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def slug(self):
        """Gets the slug of this Make.  # noqa: E501

        Manufacturer slug name (e.g. `mitsubishi`)  # noqa: E501

        :return: The slug of this Make.  # noqa: E501
        :rtype: str
        """
        return self._slug
    ...
    @slug.setter
    def slug(self, slug):
        """Sets the slug of this Make.

        Manufacturer slug name (e.g. `mitsubishi`)  # noqa: E501

        :param slug: The slug of this Make.  # noqa: E501
        :type: str
        """
        if slug is None:
    ...
    @property
    def name(self):
        """Gets the name of this Make.  # noqa: E501

        Manufacturer name (e.g. `Mitsubishi`)  # noqa: E501

        :return: The name of this Make.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this Make.

        Manufacturer name (e.g. `Mitsubishi`)  # noqa: E501

        :param name: The name of this Make.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def name_en(self):
        """Gets the name_en of this Make.  # noqa: E501

         Original english name. Use it along with _**`lang`**_ query parameter    # noqa: E501

        :return: The name_en of this Make.  # noqa: E501
        :rtype: str
        """
    ...
    def name_en(self, name_en):
        """Sets the name_en of this Make.

         Original english name. Use it along with _**`lang`**_ query parameter    # noqa: E501

        :param name_en: The name_en of this Make.  # noqa: E501
        :type: str
        """
        if name_en is None:
